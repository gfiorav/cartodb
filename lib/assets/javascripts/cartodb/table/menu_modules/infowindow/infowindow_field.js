  ...
  cdb.admin.mod.InfowindowField = cdb.core.View.extend({
    ...
    template: _.template(
      '<span class="ellipsis"><%= typeof(syncName)!== "undefined"? syncName : (alias) ? alias : fieldName %></span>\
      <div class="switches">\
    ...
    initialize: function() {
      ...
      if (this.isSync) {
        this.syncName = Sugar.String.titleize(this.options.field);
      }
    ...
    toggle: function(e) {
      ...
      if (!this.model.containsField(this.fieldName)) {
        this.model.addField(this.fieldName, this.position, this.alias);
      } else {
