...
var FiltersView = require('../../dashboard/filters_view');
...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    this._filtersModel = new cdb.core.Model({ isSecondRowActive: false });
  ...
  _initBinds: function() {
    this._filtersModel.bind('change:isSecondRowActive', this._onIsSecondRowActive, this);
    ...
    this.add_related_model(this._filtersModel);
  },
  ...
  _onIsSecondRowActive: function (model) {
    var $navigationList = this.$el.find('.Header-navigationList');
    if (model.get('isSecondRowActive')) {
        $navigationList.hide();
    } else {
        $navigationList.show();
    }
