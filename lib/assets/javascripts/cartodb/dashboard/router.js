...
module.exports = Router.extend({
  ...
  routes: {
    ...
    // Samples
    'maps/samples':                            '_changeRouteToMaps',
  ...
  _changeRouteToMaps: function(page) {
    ...
    var samples = this._doesCurrentUrlContain('maps/samples');
    var bSample =  this.model.get('samples');
    console.log("value of bSample is ", bSample);
