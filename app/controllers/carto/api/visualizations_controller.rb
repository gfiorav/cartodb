        ...
        if hideSharedEmptyDataset then
          ...
          if current_user
            ...
            response.merge!({
              ...
              total_library: VisualizationQueryBuilder.new.with_type(Carto::Visualization::TYPE_REMOTE).with_user_id(current_user.id).without_synced_external_sources.without_imported_remote_visualizations.with_excluded_names(excludedNames).build.count
            })
          end
        else
          # TODO: undesirable table hardcoding, needed for disambiguation. Look for
          ...
          if current_user
            ...
            response.merge!({
              ...
              total_library: VisualizationQueryBuilder.new.with_type(Carto::Visualization::TYPE_REMOTE).with_user_id(current_user.id).without_synced_external_sources.without_imported_remote_visualizations.build.count
            })
          end
        end
