cdb.admin.MapOptionsDropdown = cdb.core.View.extend({
  ...
  desktopOverlays: ["shareable", "zoom", "inset_map"],
  ...
  _setupOptions: function() {
    ...
    var simpleOverlays = ["search", "shareable", "zoom", "fullscreen", "layer_selector", "inset_map", "logo"];
  ...
  render: function() {
    ...
    var switches = ['title', 'description', 'search', 'zoom', 'fullscreen', 'scrollwheel', 'layer_selector', 'legends', 'inset_map'];
